...
export const Route = createFileRoute("/a-propos")({
  head: () => ({
    meta: [
      {
        title: "Qui sommes-nous ? Le cabinet qui vérifie avant d'affirmer | Placement-éthique.fr",
      },
      {
        name: "description",
        content:
...
const valeurs = [
  ...
  },
  {
    ...
    phrase:
      "Qui nous paie, combien et pourquoi : notre grille est publiée en clair, chiffre par chiffre.",
  },
  {
    icon: Scale,
    titre: "Exigence sans dogmatisme",
    phrase:
      "Aucune posture absolutiste sur un label ou une stratégie : quand un débat existe, nous l'exposons au lieu de le trancher à votre place.",
  },
  {
    icon: CalendarCheck,
    titre: "Constance dans la durée",
    phrase:
      "L'accompagnement ne s'arrête pas à la signature : nous vérifions dans le temps que vos placements restent alignés avec vos exigences.",
  },
];
...
function AProposPage() {
  return (
    <SiteLayout>
        ...
        <div className="container-prose">
          <div className="text-center mb-14">
            ...
            <h2 className="display-2 mt-4">
              Deux personnes réelles, joignables, responsables de ce qu'elles écrivent
            </h2>
          </div>
      ...
      <section
        className="section border-b border-border/40"
          ...
          <div className="grid items-start gap-12 md:grid-cols-12 lg:gap-16">
            ...
            <div className="md:col-span-7">
              ...
              <h2 className="display-3 mt-4 font-display">
                Né d'un constat : l'éthique est devenue un argument de vente avant d'être une
                méthode
              </h2>
              <div className="mt-6 space-y-5 text-[15px] leading-relaxed text-foreground/80">
                <p>
                  Labels qui se multiplient, fonds reclassés du jour au lendemain vers des
                  catégories réglementaires moins exigeantes, promesses d'impact rarement vérifiées
                  : l'investissement responsable a un problème de confiance — et il l'a bien
                  cherché. Beaucoup d'épargnants qui veulent que leur argent serve leurs valeurs
                  finissent par renoncer, non par manque de produits, mais faute de savoir à qui se
                  fier.
                </p>
                <p>
                  Placement-ethique.fr est né pour répondre à cette défiance avec la même rigueur
                  qu'un gestionnaire de patrimoine applique à la fiscalité ou à l'allocation
                  d'actifs : vérifier avant d'affirmer, sourcer avant de proposer, et dire
                  clairement ce qui est solide — et ce qui ne l'est pas. Nous lisons les documents
                  réglementaires plutôt que les brochures, et nous écrivons publiquement ce que nous
                  en concluons.
                </p>
                <div className="my-6 border-l-2 py-1 pl-6" style={{ borderColor: "var(--grenat)" }}>
                  <p className="text-[15px] leading-relaxed text-foreground/85">
                    Soyons clairs sur un point : nous ne prétendons pas détenir une vérité
                    définitive sur ce qui est « vraiment » éthique. Il n'existe pas de référentiel
                    unique et incontesté en la matière, et quiconque affirme le contraire cherche
                    surtout à vous vendre le sien. Notre métier est de vérifier les faits — ce qu'un
                    label garantit, ce qu'un fonds détient, ce qu'un reporting publie. Là où
                    plusieurs lectures légitimes coexistent — exclure les secteurs controversés ou y
                    rester pour peser en tant qu'actionnaire, se satisfaire d'un label ou exiger
                    davantage — nous vous présentons les options et leurs nuances, plutôt que
                    d'imposer la nôtre.
                  </p>
                </div>
                <p>
                  Notre indépendance se mesure à un fait simple : nous n'avons aucun fonds « maison
                  » à défendre, aucune banque ni société de gestion actionnaire de notre structure.
                  Nos liens commerciaux existent — ils sont décrits plus bas et chiffrés sur notre
                  page de tarifs, pas dissimulés en bas de page.
                </p>
              </div>
            </div>
      ...
      <section className="section border-b border-border/40">
        <div className="container-prose max-w-3xl text-center">
          ...
          <div className="mt-6 space-y-4 text-[16px] leading-relaxed text-foreground/80">
            <p>
              Nous publions, en clair, les réponses aux questions que les épargnants se posent
              réellement : ce que coûte un placement, ce qu'un label garantit — et ne garantit pas
              —, les limites d'un produit, les comparaisons que l'industrie préfère éviter. Ce que
              d'autres réservent à un rendez-vous commercial, nous le mettons en ligne.
            </p>
            <p>
              Notre conviction : un épargnant bien informé prend de meilleures décisions — et
              devient, le moment venu, un client serein. C'est aussi une question de cohérence : on
              ne peut pas reprocher au marché son opacité et cultiver la sienne.
            </p>
          </div>
        ...
        <div className="container-prose max-w-3xl">
          ...
          >
            ...
            <div className="mt-6 space-y-5 text-[16px] leading-relaxed text-foreground/85">
              <p>
                La question mérite une réponse franche — c'est la première que nous posons aux
                acteurs que nous examinons, elle vaut donc aussi pour nous. Nos rendez-vous sont
              ...
              <p>
                ...
                plateformes — sous forme de commissions et de rétrocessions sur les frais. C'est le
                modèle classique du courtage et de l'apport d'affaires : nous l'assumons, et nous le
                documentons.
              </p>
              <p className="font-medium text-foreground">
                Plutôt que de l'écrire en petits caractères, nous avons publié notre grille de
                rémunération, solution par solution, chiffre par chiffre.
              </p>
            </div>
      ...
      >
        ...
        <div className="container-prose relative z-10 max-w-3xl">
          ...
          <div className="mt-8 space-y-5 text-[16px] leading-relaxed text-white/80">
            <p>
              Un site qui vous demande de vérifier qui se cache derrière chaque promesse vous doit
              la même clarté sur sa propre structure. La voici.
            </p>
            <ul className="mt-4 space-y-4">
              <li className="flex gap-3">
                ...
                />
                <span>
                  <strong className="text-white">Placement-ethique.fr</strong> est notre identité et
              ...
              <li className="flex gap-3">
                ...
                />
                <span>
                  <strong className="text-white">EXP Capital</strong> (SASU au capital de 1 000 €,
                  RCS Versailles 987 986 247) est l'entité qui édite ce site : elle est inscrite à
                  l'ORIAS sous le n° 25005915 (
                  <a
              ...
              <li className="flex gap-3">
                ...
                />
                <span>
                  Les contenus de ce site sont informatifs et éducatifs : ils ne constituent pas un
                  conseil en investissement. Tout ce qui touche à votre situation personnelle se
                  décide de vive voix, avec votre conseiller — jamais depuis une page web.
                </span>
              </li>
            </ul>
          </div>
